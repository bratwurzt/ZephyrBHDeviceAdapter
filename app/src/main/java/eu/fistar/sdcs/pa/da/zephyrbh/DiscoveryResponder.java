...
public class DiscoveryResponder extends BroadcastReceiver
{
  ...
  static class CapabilitiesConstants
  {
    ...
    // Generic Constants
    public static final String DA_ID = "eu.fistar.sdcs.pa.da.zephyrbh";
    ...
    public static final String CAP_FRIENDLY_NAME = "Zephyr BioHarness Device Adapter";
    public static final String CAP_ACTION_NAME = DA_ID + ".ZephyrBHDeviceAdapter";
